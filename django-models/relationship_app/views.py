...
def login_view(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('home')  # Replace 'home' with the name of the view/URL where you want to redirect
        else:
...
def add_book(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            form.save()
            return redirect('book_list')  # Redirect to the book list view after adding
    else:
        form = BookForm()
